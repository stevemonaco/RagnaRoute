...
public record ScheduledQuestModel(string ObjectiveName, string Description, List<string> Information, DateTimeZone TimeZone, CronExpression Repeat, int Duration);
